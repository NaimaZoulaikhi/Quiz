...
public class successfullySubmited extends javax.swing.JFrame {
    ...
    public successfullySubmited(String marks) {
        initComponents();
        String marks1="Note obtenu  : "+marks;
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Mis à jour avec succÉs .");
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 380, -1, -1));

        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Project/S.jpg"))); // NOI18N
